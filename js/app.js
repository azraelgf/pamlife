(() => {
    ...
    function initSliders() {
        if (document.querySelector(".case__body")) new swiper_core_Swiper(".case__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".case-item-images__body")) new swiper_core_Swiper(".case-item-images__body", {
            ...
            navigation: {
                prevEl: ".images-btn-prev",
                nextEl: ".images-btn-next"
            },
            on: {}
        });
    }
